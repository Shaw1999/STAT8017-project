...
# param_grid = {'n_estimators': [50, 100, 200], 'max_depth': list(range(1, 21)), 'min_samples_leaf': [1, 5, 10, 20, 50, 100]}
param_grid = {'n_estimators': [50, 100, 200], 'max_depth': [1, 5, 10, 20], 'min_samples_leaf': [1, 5, 10, 20, 50, 100]}
...
with open("3-random forest-result.txt", "w") as file:
