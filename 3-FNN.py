...
with open("3-FNN-result.txt", "w") as file:
...
# Save the best model
torch.save(grid_search.best_estimator_.module_.state_dict(), 'best_fnn_model.pt')
...
best_fnn_model.load_state_dict(torch.load('best_fnn_model.pt'))

# Now you can use the best_fnn_model for evaluation or predictions
